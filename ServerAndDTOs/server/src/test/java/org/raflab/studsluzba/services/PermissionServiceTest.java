...
class PermissionServiceTest{
 @Test void adminDoesNotAutomaticallyReceiveFinanceWrite(){
  ...
  assertThat(service.has(Permission.FINANCE_WRITE)).isFalse();assertThat(service.has(Permission.SECURITY_ADMIN)).isTrue();
 }
}
