...
class ScheduleServiceTest{
 @Test void overlappingSessionIsRejected(){
  ...
  ScheduleService service=new ScheduleService(mock(RoomRepository.class),mock(StudentGroupRepository.class),sessions,mock(ExamRoomAssignmentRepository.class),mock(NastavnikRepository.class),mock(IspitRepository.class),mock(StudentIndeksRepository.class),mock(StudentGroupMembershipRepository.class));
