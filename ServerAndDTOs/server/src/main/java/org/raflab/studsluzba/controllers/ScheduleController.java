...
public class ScheduleController{
 ...
 @PostMapping("/groups/{groupId}/students/{indeksId}")public StudentGroupMembership addStudent(@PathVariable Long groupId,@PathVariable Long indeksId){currentUser.requireAdmin();return service.addStudentToGroup(groupId,indeksId);}
 ...
 @GetMapping("/groups/{groupId}")public List<ClassSession> calendar(@PathVariable Long groupId){currentUser.requireCanAccessScheduleGroup(groupId);return service.groupCalendar(groupId);}
 @GetMapping(value="/groups/{groupId}.ics",produces="text/calendar")public String calendarIcs(@PathVariable Long groupId){currentUser.requireCanAccessScheduleGroup(groupId);return service.groupCalendarIcs(groupId);}
}
